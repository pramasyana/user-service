...
// FindActiveMerchantBankByID provides a mock function with given fields: ctxReq, uid
func (_m *MerchantBankRepository) FindActiveMerchantBankByID(ctxReq context.Context, uid int) <-chan repo.ResultRepository {
